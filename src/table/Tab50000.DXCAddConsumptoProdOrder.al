table 50000 "DXCAddConsumptoProdOrder"
{
    ...
    fields
    {
        field(10;"Released Prod Order No.";Code[20])
        {
            ...
            begin
                ...
                if Rec."Released Prod Order No." <> xRec."Released Prod Order No." then begin
                   ProdOrder.GET(ProdOrder.Status::Released,"Released Prod Order No.");
    ...
    keys
    {
        key(Key1;"Released Prod Order No.")
        {
        }
    }
    ...
    begin
        ...
        ProdOrderLine.SETRANGE("Prod. Order No.","Released Prod Order No.");
    ...
    begin
        ...
        PProdOrder.CreatePickDXC(USERID,0,false,false,false, "Item No.");
    end;
    ...
    begin
        ...
        if WhseActivityLine.FINDFIRST then begin
          ...
          WhseActivityLine.VALIDATE("Bin Code","Take Bin");
